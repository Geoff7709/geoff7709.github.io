                ...
                <div className="col-md">
                    <div className="card">
                        ...
                        <div className="card-body">
                            <h4>GitHub Profile: <a href="https://github.com/Geoff7709" target="_blank" className="card-link">https://github.com/Geoff7709</a></h4>
                            <h4>LinkedIn: <a href="https://www.linkedin.com/in/geoffzimmerman23/" target="_blank" className="card-link">https://www.linkedin.com/in/geoffzimmerman23/</a></h4>
                            <h4><a href="https://docs.google.com/document/d/1UnyIADUvbvS3Nha7QGKYRby7bvEVI8bsuknDCsY8k2k/edit?usp=sharing" target="_blank" className="card-link">Resume Link</a></h4>
                        </div>
